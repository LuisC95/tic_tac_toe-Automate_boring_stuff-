...
def scores_updating(player_in_turn, waiting_player):
    ...
    while True or not player_in_turn['last_game_winner']:
        if player_in_turn['last_game_winner'] == True:
            ...
            player_in_turn['average'] = round(float((player_in_turn['won_games'] / player_in_turn['games_played'])*100), 2)
            player_in_turn['tied_games'] = round(float((player_in_turn['games_played'] - player_in_turn['won_games'] - player_in_turn['lost_games']/player_in_turn['games_played'])*100), 2)
            player_in_turn['lost_percentage'] = round(float((player_in_turn['lost_games'] / player_in_turn['games_played'])*100), 2)
            waiting_player['average'] = round(float((waiting_player['won_games'] / waiting_player['games_played'])*100), 2)
            waiting_player['tied_games'] = round(float((waiting_player['games_played'] - waiting_player['won_games'] - waiting_player['lost_games'])*100), 2)
            ...
            waiting_player['average'] = round(float((waiting_player['won_games']) / waiting_player['games_played'])*100, 2)
            waiting_player['lost_percentage'] = round(float((waiting_player['lost_games'] / waiting_player['games_played'])*100), 2)
            waiting_player['tied_games'] = round(float((waiting_player['games_played'] - waiting_player['won_games'] - waiting_player['lost_percentage']/waiting_player['games_played'])*100), 2)
            player_in_turn['average'] = round(float((player_in_turn['won_games'] / player_in_turn['games_played'])*100), 2)
            player_in_turn['tied_games'] = round(float((player_in_turn['games_played'] - player_in_turn['won_games'] - player_in_turn['lost_percentage']/player_in_turn['games_played'])*100), 2)
